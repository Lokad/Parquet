...
{
    /// <summary>Gets the immutable non-negative source length in bytes.</summary>
    long Length { get; }

    /// <summary>Reads exactly <paramref name="destination"/> from <paramref name="offset"/>.</summary>
    /// <remarks>The library issues reads sequentially with no concurrent outstanding reads.</remarks>
    /// <param name="offset">The non-negative source offset.</param>
    /// <param name="destination">The destination buffer.</param>
    /// <param name="cancellationToken">Cancellation observed by the read.</param>
    ...
    /// <exception cref="OperationCanceledException">The read observed <paramref name="cancellationToken"/>.</exception>
